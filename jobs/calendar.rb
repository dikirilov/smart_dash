...
# ------
calendars = [{name: 'Google Calendar', url: 'https://www.google.com/calendar/feeds/dikirilovskiy%40gmail.com/public/basic'}]
events = Array.new
...
SCHEDULER.every '1m', :first_in => 0 do |job|
	...
	events = events.slice!(0,1) # 15 elements is probably enough...
